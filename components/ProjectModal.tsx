...
export default function ProjectModal({ project, onClose }: ProjectModalProps) {
    ...
    // Determine the live URL: Use homepage if set, otherwise fallback to GitHub Pages convention.
    ...
    return (
        <>
            <h2 className="text-2xl font-heading text-highlight mb-6 font-bold">{project.name}</h2>
            ...
            <p className="mt-6 text-text-muted ">{project.description}</p>
