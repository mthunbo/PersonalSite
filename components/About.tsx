                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-16 items-center">
                    ...
                    <div className="flex flex-col gap-6 text-lg text-text leading-relaxed font-body">
                        <p>
                            ...
                            {/*English version*/}
                            My journey into code is a bridge between two passions: the structured wisdom of ancient history and the limitless potential of science fiction. 
                            I see development as a modern form of craftsmanship, a way to forge order from chaos and bring thoughtful ideas to life, one line at a time.
                        </p>
                        <p>
                            {/*Danish version*/}
                            ...
                            {/*English version*/}
                            This dual perspective comes from years spent painting miniatures, where success lies in both meticulous, pixel-perfect details and a grand, strategic vision. 
                            "My mind thrives in what I call 'structured chaos.' 
                            I have a natural aptitude for navigating complexity, which allows me to find elegant patterns and build robust, scalable systems where others might only see an intricate challenge."
                        </p>
                        <p>
                            {/*Danish version*/}
                            ...
                            {/*English version*/}
                            Ultimately, I believe technology should serve our shared humanity. 
                            My goal is not just to solve technical challenges, but to build tools that are intuitive, accessible, and bring us closer to a more united and compassionate future. 
                            For me, a problem isn't a blockade; it's the foundation for the next bridge we'll build together.
                        </p>
